...
var OneDriveFilesTab = (function (_super) {
    ...
    function OneDriveFilesTab(props) {
        ...
        _this._handleSelectionChange = function (filePickerResult) {
            if (filePickerResult) {
                filePickerResult.downloadFileContent = function () { return _this.props.oneDriveService.downloadSPFileContent(filePickerResult.fileAbsoluteUrl, filePickerResult.fileName); };
            }
            _this.setState({
