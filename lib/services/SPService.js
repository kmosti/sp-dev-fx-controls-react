...
var SPService = (function () {
     ...
     * Get List Items
     */
    SPService.prototype.getListItems = function (filterText, listId, internalColumnName, keyInternalColumnName, webUrl) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        apiUrl = webAbsoluteUrl + "/_api/web/lists('" + listId + "')/items?$select=" + (keyInternalColumnName || 'Id') + "," + internalColumnName + "&$filter=startswith(" + internalColumnName + ",'" + filterText + "')";
